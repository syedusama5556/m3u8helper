...
import com.utech.m3u8helper.model.M3U8Ts;
...
class M3U8DownloadTask {
    ...
    public M3U8DownloadTask(){
        connTimeout = M3U8Config.getConnTimeout();
        readTimeout = M3U8Config.getReadTimeout();
        threadCount = M3U8Config.getThreadCount();
    }
            ...
            executor.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        sb.deleteCharAt(sb.length()-1);
                        sb.deleteCharAt(sb.length()-1);
                        sb.append("_").append(System.currentTimeMillis()).append(".ts");

                        m3U8Ts.setFileName(sb.toString());
                        file = new File(dir + File.separator + sb.toString());
                    } catch (Exception e) {
                        file = new File(dir + File.separator + m3U8Ts.getUrl()+"_"+System.currentTimeMillis());
                    }
