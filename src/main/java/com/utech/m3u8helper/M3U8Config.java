...
import com.utech.m3u8helper.utils.SPHelper;
...
public class M3U8Config {
    ...
    public static M3U8Config build(Context context){
        SPHelper.init(context);
        return new M3U8Config();
    }

    public M3U8Config setSaveDir(String saveDir){
        SPHelper.putString(TAG_SAVE_DIR, saveDir);
        return this;
    }

    public static String getSaveDir(){
        return SPHelper.getString(TAG_SAVE_DIR, Environment.getExternalStoragePublicDirectory(DIRECTORY_DOWNLOADS) + File.separator + "InstaStory/m3u8file");
    }

    public M3U8Config setThreadCount(int threadCount){
    ...
    public M3U8Config setConnTimeout(int connTimeout){
    ...
    public M3U8Config setReadTimeout(int readTimeout){
    ...
    public M3U8Config setDebugMode(boolean debug){
